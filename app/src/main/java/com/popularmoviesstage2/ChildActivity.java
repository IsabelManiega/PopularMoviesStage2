...
import com.popularmoviesstage2.adapters.TrailerAdapter;
import com.popularmoviesstage2.data.MovieContract;
import com.popularmoviesstage2.datatypes.Trailer;
import com.popularmoviesstage2.datatypes.TrailersList;
...
public class ChildActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Trailer>>,TrailerAdapter.TrailerAdapterOnClickListener, View.OnClickListener {
    ...
    private void setMovieDetails() {
        Picasso.with(this)
                ...
                .into(backdrop);
        movie_rating.setText("Rating: " + voteAverage + "/10");
